...
## Package development 
### One way of developing R packages is using the devtools, and usethis package [https://cran.r-project.org/web/packages/usethis/usethis.pdf](https://cran.r-project.org/web/packages/usethis/usethis.pdf). 
...
2. automate documentation after insert roxygen skeleton into each function (Ctrl + shift + Alt + R)
```{r eval=F}
devtools::document()
```
